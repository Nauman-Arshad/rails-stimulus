...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference("Batch.count") do
      post batches_url, params: { batch: { city: @batch.city, country: @batch.country, name: @batch.name, phone: @batch.phone, state: @batch.state } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { city: @batch.city, country: @batch.country, name: @batch.name, phone: @batch.phone, state: @batch.state } }
